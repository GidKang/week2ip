...
function checkGender(){
    ...
    switch(gender){
        ...
        case gender = "female":
            switch(day){
              case 0 || -0:
                document.getElementById("result").innerHTML = "The day was a Sunday." + "  " + "Your akan name is  akosua";
              break;
              case 1 || -1:
                document.getElementById("result").innerHTML = "The day was a Monday." + " " + "Your akan name is adwoa ";
              break;
              case 2 || -2:
                document.getElementById("result").innerHTML = "The day was a Tuesday." + " " + "Your akan name is abenaa";
              break;
              case 3 || -3:
                document.getElementById("result").innerHTML = "The day was a Wednesday." + " " + "Your akan name is akua";
              break;
              case 4 || -4:
                document.getElementById("result").innerHTML = "The day was a Thursday." + " " + "Your akan name is yaa";
              break;
              case 5 || -5:
                document.getElementById("result").innerHTML = "The day was a Friday." + " " + "Your akan name is afua";
              break;
              case 6 || -6:
                document.getElementById("result").innerHTML = "The day was a Saturday." + " " + "Your akan name is ama";
              break;
